...
const Newsletter = ({ title }) => {
    return (
        <Box mb="48px" d="flex" justifyContent={'center'} alignItems="center" bg="newsletter" h="352px">
            <Box
                ml={{ base: '18px', md: 0 }}
            ...
            >
                ...
                <Box d={'flex'} flexDir={{ base: 'column', md: 'row', lg: 'row' }} justifyContent="space-between">
                    <Input
                        bg="white"
